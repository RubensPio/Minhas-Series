...
class Series extends Component{
    ...
    loadData(){
        ...
        api.loadSeriesByGenre(this.props.match.params.genres).then((res) => {
            this.setState({
                isLoad: false,
                series: res.data
            })
    ...
    render(){
        return(
            ...
            {
                !this.state.isLoad && this.state.series.length === 0 &&
                <div className='alert alert-info'>
                    Nenhuma série cadastrada no gênero { this.props.match.params.genres }
                </div>
            }
